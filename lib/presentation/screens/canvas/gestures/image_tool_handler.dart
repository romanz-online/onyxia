...
class ImageToolHandler extends CanvasToolGestureHandler {
  const ImageToolHandler({required super.canvasConfig});
  ...
  @override
  void Function(TapDownDetails, WidgetRef, BuildContext, CanvasInteractionContext)? get onTapDown =>
