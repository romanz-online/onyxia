...
class ArrowToolHandler extends CanvasToolGestureHandler {
  ArrowToolHandler({required super.canvasConfig});
  ...
  void Function(TapUpDetails, WidgetRef, BuildContext, CanvasInteractionContext)? get onTapUp =>
      (details, ref, buildContext, interactionContext) {
        ...
        switch (interactionContext) {
          case ArrowToolWellInteraction(:final sourceObject, :final startOffset, :final closestEdge):
          ...
          case ObjectFillInteractionContext(:final targetObject):
            final arrowToolWellData = ref.read(arrowToolPrimedObjectsProvider);

            if (gestureState.interactionContext == null && arrowToolWellData != null) {
              final arrow = ArrowInteractionService.startArrowWellPan(
                DragStartDetails(globalPosition: details.globalPosition, localPosition: details.localPosition),
                targetObject,
          ...
          case BackgroundInteraction():
            if (gestureState.interactionContext != null) {
              ArrowInteractionService.endArrowPan(DragEndDetails(), ref, gestureState.activeObject, true, canvasConfig);
  ...
  void Function(PointerHoverEvent, WidgetRef, BuildContext, CanvasInteractionContext)? get onHover =>
      (event, ref, buildContext, interactionContext) {
        final gestureState = ref.read(canvasGestureStateProvider);
        if (gestureState.interactionContext == null || gestureState.activeObject?.isArrow == false) {
          return;
        }
        ...
        ArrowInteractionService.updateArrowPan(
          DragUpdateDetails(
            ...
            delta: _lastHoverPosition != null ? event.position - _lastHoverPosition! : Offset.zero,
          ),
          ref,
          gestureState.activeObject,
        );
  ...
  void Function(DragUpdateDetails, WidgetRef, BuildContext, CanvasInteractionContext)? get onPanUpdate =>
      (details, ref, buildContext, interactionContext) {
        ArrowInteractionService.updateArrowPan(details, ref, ref.read(canvasGestureStateProvider).activeObject);
      };
  ...
  void Function(DragEndDetails, WidgetRef, BuildContext, CanvasInteractionContext)? get onPanEnd =>
      (details, ref, buildContext, interactionContext) {
        ArrowInteractionService.endArrowPan(
            details, ref, ref.read(canvasGestureStateProvider).activeObject, true, canvasConfig);
