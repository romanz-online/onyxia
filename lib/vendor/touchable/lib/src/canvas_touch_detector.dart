      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          ...
          onTapDown: !widget.gesturesToOverride.contains(GestureType.onTapDown)
              ...
              : (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onTapDown, tapDetail),
                  );
                },
          ...
          onHorizontalDragDown:
              !widget.gesturesToOverride.contains(
          ...
          onLongPressEnd:
              ...
              : (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onLongPressEnd, tapDetail),
                  );
                },
          ...
          onScaleStart:
              ...
              : (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onScaleStart, tapDetail),
                  );
                },
          onScaleUpdate:
              ...
              : (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onScaleUpdate, tapDetail),
                  );
                },
          onForcePressStart:
          ...
          onPanStart:
              ...
              : (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onPanStart, tapDetail),
                  );
                },
          onPanUpdate:
              ...
              : (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onPanUpdate, tapDetail),
                  );
                },
          onPanEnd: !widget.gesturesToOverride.contains(GestureType.onPanEnd)
              ...
              : (dragEndDetails) {
                  touchController.add(
                    Gesture(GestureType.onPanEnd, dragEndDetails),
                  );
                },
          onPanDown: !widget.gesturesToOverride.contains(GestureType.onPanDown)
              ...
              : (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onPanDown, tapDetail),
                  );
                },
          onSecondaryTapDown:
              !widget.gesturesToOverride.contains(
