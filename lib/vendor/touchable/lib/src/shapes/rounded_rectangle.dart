    ...
    if (paint.style == PaintingStyle.fill) {
      ...
      bool insideOuterRect = RRect.fromLTRBAndCorners(
        ...
        topLeft: Radius.elliptical(
          rRect.tlRadiusX + extraWidth,
          rRect.tlRadiusY + extraWidth,
        ),
        topRight: Radius.elliptical(
          rRect.trRadiusX + extraWidth,
          rRect.trRadiusY + extraWidth,
        ),
        bottomLeft: Radius.elliptical(
          rRect.blRadiusX + extraWidth,
          rRect.blRadiusY + extraWidth,
        ),
        bottomRight: Radius.elliptical(
          rRect.brRadiusX + extraWidth,
          rRect.brRadiusY + extraWidth,
        ),
      ).contains(p);
