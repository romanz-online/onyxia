...
class ThemeHelper {
  ...
  static Color background1() => NarwhalColors.neutral900;
  static Color background2() => NarwhalColors.neutral800;
  static Color auxiliary() => NarwhalColors.neutral700;
  static Color foreground1() => NarwhalColors.neutral200;
  static Color foreground2() => NarwhalColors.neutral500;
  static Color accent() => NarwhalColors.orange;
  static Color error() => NarwhalColors.red500;
}
